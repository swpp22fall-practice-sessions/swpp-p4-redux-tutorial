...
export const todoSlice = createSlice({
    ...
    reducers: {
        ...
        extraReducers: (builder) => {
            builder.addCase(fetchTodos.fulfilled, (state, action) => {state.todo = action.payload});
            builder.addCase(fetchTodo.fulfilled, (state, action) => {state.selectedTodo = action.payload});
            builder.addCase(postTodo.rejected, (_state, action) => {console.error(action.error)});
        }
    },
});
